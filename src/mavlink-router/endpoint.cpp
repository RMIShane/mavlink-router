                          ...
                          uint8_t src_compid, uint32_t msg_id)
{
    ...
    // This endpoint is redundant and we have received a heartbeat from a higher priority endpoint in the last 2 seconds.
    if ((sys_priority > 0 ) && (sys_priority > current_sys_priority)){
       return false;
    }       
